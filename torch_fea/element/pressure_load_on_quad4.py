...
from torch_fea.element.SurfaceElement_quad4 import cal_dh_du_and_dh_dv, get_integration_point, get_shape_integration_weight
#%%
...
if __name__ == "__main__":
    ...
    t0=time.time()
    force_4i = cal_nodal_force_from_pressure(pressure, x, n_integration_points=4)
